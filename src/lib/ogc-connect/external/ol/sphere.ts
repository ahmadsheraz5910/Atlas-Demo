...
import { ProjectionLike } from './proj.js';
 ...
 * @api
 */
export function getDistance(c1: Array<any>, c2: Array<any>, radius?: number): number {
 ...
 */
function getLengthInternal(coordinates: Array<any>, radius: number): number {
  let length = 0;
 ...
 */
function getAreaInternal(coordinates: Array<import("./coordinate.js").Coordinate>, radius: number): number {
  let area = 0;
