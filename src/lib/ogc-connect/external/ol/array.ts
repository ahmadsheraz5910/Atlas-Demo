 ...
 * @api
 */
type NearestDirectionFunction = (a:number,b:number,c:number) => number
/**
 ...
 */
export function reverseSubArray(arr: Array<any>, begin: number, end: number) {
  while (begin < end) {
    const tmp = arr[begin];
    arr[begin] = arr[end];
    arr[end] = tmp;
 ...
 * @template VALUE
 */
export function extend<VALUE>(arr: Array<VALUE>, data: Array<VALUE> | VALUE) {
 ...
 * @api
 */
export function stableSort(arr: Array<any>, compareFnc: (arg0: any, arg1: any) => number) {
